\chapter{Which Ice Cream is the Best?}
...
\begin{figure} 
  \includegraphics[width=0.50\textwidth]{schoolseal.jpg} % Can adjust size <-
...
% If you want caption above, simply put it above "\includegraphics"
  \label{fig:logo}
\end{figure}

\begin{table}[bth] % [bth] Tells LaTeX we want the table at the bottom (b) if possible
                   % if not then the top (t) is next best, lastly here (h)
                   % if you put [h] alone, then God smites a puppy. Lastly [p] will put the 
                   % on a special page for just figures.
\small             % lets make our table small!
\caption{The best ice cream toppings ranked.}
\begin{tabular}{|lcc|} \firsthline  % The | lines here tell Latex we want vertical lines there
